  ...
  return (
    <footer className="relative w-full pt-20 pb-10 overflow-hidden font-sans">
      ...
      <div 
        ...
        style={{ background: 'linear-gradient(to bottom, #ffffff 0%, #f1f5f9 100%)' }} 
      />
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 md:px-12">
        ...
        {/* Main Footer Content */}
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          
          {/* Column 1: Brand & Socials */}
          <div className="space-y-6">
            <div className="flex items-center gap-2.5">
              <img src="/logo_black.svg" alt="Raasta Realty Logo" className="h-12 rounded-xl" />
            </div>
            <p className="text-slate-500 text-sm leading-relaxed pr-4">
              Premium real estate brokerage based in Dubai, specializing in luxury residential and high-yield investment properties.
            </p>
          ...
          <div>
            <h4 className="font-bold text-slate-900 mb-6 text-lg">Properties</h4>
            <ul className="space-y-4 text-sm font-medium text-slate-500">
              {['Dubai Marina', 'Palm Jumeirah', 'Downtown Dubai', 'Dubai Hills', 'New Projects'].map((item) => (
                <li key={item}>
                  <a href="#" className="group flex items-center gap-2 hover:text-[#2EA8FF] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium text-slate-500">
              {['About Us', 'Meet the Team', 'Careers', 'Market Reports', 'Contact'].map((item) => (
                <li key={item}>
          ...
          <div className="lg:pl-8">
            ...
            <div className="mt-6 p-4 bg-white/60 backdrop-blur-sm border border-slate-100 rounded-xl">
               ...
               <p className="text-[10px] text-slate-400 mt-1">Q3 2024 Analysis Available</p>
            </div>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-slate-200/60 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium text-slate-400">
          ...
          <div className="flex gap-8">
            <a href="#" className="hover:text-[#2EA8FF] transition-colors">Privacy Policy</a>
            <a href="#" className="hover:text-[#2EA8FF] transition-colors">Terms of Service</a>
            <a href="#" className="hover:text-[#2EA8FF] transition-colors">RERA Info</a>
          </div>
        </div>
